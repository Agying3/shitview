...
from shitview.core.diff import diff_snapshots
from shitview.core.events import EventBus, StatusMessage
from shitview.core.labels import LabelStore
from shitview.core.repository import ProjectRepository
from shitview.services.scanner import FileSystemScanner
from shitview.services.watcher import PollingFolderWatcher


@dataclass(slots=True)
class ShitviewEngine:
    root: Path
