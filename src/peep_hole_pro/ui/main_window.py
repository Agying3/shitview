...
from peep_hole_pro.services.layout_store import UserLayoutStore
from peep_hole_pro.ui.graphics_view import ZoomableGraphicsView
from peep_hole_pro.ui.canvas import MapCanvas
from peep_hole_pro.ui.theme import APP_STYLESHEET
...
class TitleBar(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.title = QLabel('PEEP-HOLE-PRO')
...
class MainWindow:
    def __init__(self, engine) -> None:
        ...
        self.window.setWindowTitle('PEEP-HOLE-PRO')
    ...
    def _open_folder(self) -> None:
        ...
        if not folder:
            return
        self.engine.stop()
        self.engine = PeepHoleEngine(root=Path(folder).expanduser().resolve(), polling_interval=self.engine.polling_interval)
    ...
    def _render_tree(self, snapshot) -> None:
        from peep_hole_pro.core.time_format import format_relative_time
